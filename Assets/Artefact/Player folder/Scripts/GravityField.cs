...
public class GravityField : MonoBehaviour
{
    ...
    [SerializeField] public InteractableObject objectToShoot;
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            //check if the object exists in the lists already, and if its usuable
    ...
    public void TriggerAim(bool toggle)
    {
        ...
        if (toggle)
        {
            ...
            if (objectsInOrbit.Count > 0)
            {
                ...
                owner.defaultCameraCm.m_Orbits[1].m_Radius = owner.myProfile.aimedDistance;
        ...
        else
        {
            ...
            owner.defaultCameraCm.m_Orbits[1].m_Radius = owner.myProfile.defaultDistance;
        }
    }
